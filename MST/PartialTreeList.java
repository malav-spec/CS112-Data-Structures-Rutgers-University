...
public class PartialTreeList implements Iterable<PartialTree> {
	...
	public static PartialTreeList initialize(Graph graph) {
		...
		{
			PartialTree PT=new PartialTree(vertices[i]);
			
			while(vertices[i].neighbors!=null)
			{
				Arc arc=new Arc(graph.vertices[i],graph.vertices[i].neighbors.vertex, garphs.vertices[i].neighbors.weight);
